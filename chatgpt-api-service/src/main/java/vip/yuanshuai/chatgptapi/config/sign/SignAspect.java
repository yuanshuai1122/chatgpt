package vip.yuanshuai.chatgptapi.config.sign;

import cn.hutool.core.text.CharSequenceUtil;
import vip.yuanshuai.chatgptapi.config.exception.BusinessException;
import vip.yuanshuai.chatgptapi.utils.SignUtil;
...
public class SignAspect {
     ...
     * pointcut.
     */
    @Pointcut("execution(@vip.yuanshuai.chatgptapi.config.sign.Signature * *(..))")
